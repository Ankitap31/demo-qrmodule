...
/**
 * Define libraries classes.
 */
class JsonResourceLibrariesManager implements JsonResourceLibrariesManagerInterface {
  ...
  public function requirements() {
    ...
    return [
      'json_resource_libraries' => [
        'title' => $this->t('JsonResource: External libraries'),
